#ifndef BPHAnalysis_SpecificDecay_BPHDecayToResFlyingBuilder_h
#define BPHAnalysis_SpecificDecay_BPHDecayToResFlyingBuilder_h
...
#include "BPHAnalysis/SpecificDecay/interface/BPHDecayToFlyingCascadeBuilder.h"
